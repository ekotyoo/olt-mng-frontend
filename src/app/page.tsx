...
export default function Home() {
  ...
  async function getUncfgOnu(oltKey: string) {
    try {
      ...
      const res = await fetch("http://localhost:1234/get_unconfigured_onus", {
        method: "POST",
        headers: {
  ...
  async function getOnuDetail({
    ...
    try {
      ...
      const res = await fetch("http://localhost:1234/get_onu_details", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  async function configureOnu(onuConfig: OnuConfig) {
    try {
      ...
      const res = await fetch("http://localhost:1234/configure_onu", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
